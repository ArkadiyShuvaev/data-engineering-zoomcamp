...
python data_loader.py --file_url "$FILE_URL" --db_table_name "$DB_TABLE_NAME" --db_name "$DB_NAME" --db_host_name "$DB_HOST_NAME" --db_port "$DB_PORT" --db_user_name "$DB_USER_NAME" --db_password "$DB_PASSWORD"
